...
if (function_exists("add_theme_support")) {
    ...
    add_image_size("proyecto", 1000, 562, true); // Custom Thumbnail Size call using the_post_thumbnail('proyecto');
...
function html5blankcomments($comment, $args, $depth)
{
    ...
    <?php printf(esc_html("%s dice:"), get_comment_author_link()); ?>
    </div>
